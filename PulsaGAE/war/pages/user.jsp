		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="content">
					...
					<table id="rounded-corner"
						...
						<thead>
							<tr>
								...
								<th scope="col" class="rounded">Transaction Password</th>
						...
						<tbody>
							<c:forEach items="${listUser}" var="userinfo"
								...
								<tr>
									...
									<td>${userinfo.maskedPassword}</td>
									<td>${userinfo.password}</td>
									<td>${userinfo.name}</td>
									<td>${userinfo.email}</td>
									<td><a href="/admin/user/detail/${userinfo.username}"><img
											src="/images/user_edit.png" alt="" title="" border="0" /></a></td>
									<td><a href="/admin/user/remove/${userinfo.username}"
					...
					<form:form action="/admin/user/save" commandName="user" methodParam="POST"
						class="niceform">
