	...
	<div id="main_container">
		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="content">
				<!-- 	<h2>Import Data</h2>
					<form action="import" method="POST" class="niceform">

						<table>

							<tr>
								<td colspan="3"><input type="submit" name="submit"
									id="submit" value="Import" /></td>
							</tr>
						</table>
					</form> -->
					<h2>Empty and populate transactions from this file </h2>
					<form id="upload" action="upload"
						enctype="multipart/form-data" method="post">
						<label for="file">File xls :</label> 
						<input name="file" type="file" />*must be xls file*<br/>
						<input type="submit" value="Save" />
					</form>
					<h2>Empty and populate Product from this file </h2>
					<form id="upload" action="product"
						enctype="multipart/form-data" method="post">
						<label for="file">File xls :</label> 
						<input name="file" type="file" />*must be xls file*<br/>
						<input type="submit" value="Save" />
					</form>
					<h2>Empty and populate Customer from this file</h2>
					<form id="upload" action="customer"
						enctype="multipart/form-data" method="post">
						<label for="file">File xls :</label> 
						<input name="file" type="file" />*must be xls file*<br/>
						<input type="submit" value="Save" />
